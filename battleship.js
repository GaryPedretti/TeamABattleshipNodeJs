...
class Battleship {
    ...
    StartGame() {
        ...
        do {
            console.log('-------------------------------------------------------------------------------------------');
            console.log();
            console.log(cliColor.blue("Player") + ", it's your turn");
            ...
            console.log();
            console.log('-------------------------------------------------------------------------------------------');
            console.log(`${cliColor.red('Computer')} shot in ${computerPos.column}${computerPos.row} and ` + (isHit ? cliColor.red(`has hit your ship !`) : cliColor.blue(`miss`)));
            if (isHit) {
                beep();
                showHitAnimation();
            }
